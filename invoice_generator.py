...
class InvoiceGenerator:
    ...
    def generate_invoice(self, records, output_path, invoice_no, invoice_date):
        ...
        doc.add_paragraph(f"Invoice No: {invoice_no}   Date: {invoice_date.strftime('%d-%m-%Y')}")
        ...
        bank_rows = [("Account Name", "CPR, Pune"), ("Account Number", "10023971530"), ("Type", "Savings"), ("Bank Name", "State Bank of India"), ("Branch Address", "NCL Branch, Pashan Road, Pune - 411008"), ("Branch Code", "3552"), ("MICR Code", "411002012"), ("IFSC Code", "SBIN0003552"), ("Payee Code", "22010023828")]
